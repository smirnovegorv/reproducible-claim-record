...
OLLAMA_HANDOFF_2.md, тексты байт в байт, для прогона на Opus (Agent tool "opus") через
...
RESULTS = HERE / "results" / "claude-opus-5.jsonl"


def record(arm, i, resp):
    rec = {"model": "claude-opus-5", "digest": None, "ollama": None, "arm": arm,
